...
4. **Run the quality gate before committing:** `.claude/skills/agentic-loop/scripts/quality-gates.sh`. If it fails, fix the cause, do not edit tests to make them pass.
