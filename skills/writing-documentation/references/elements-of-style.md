<!-- Vendored from the `elements-of-style` plugin v1.0.0 (superpowers-marketplace). Source text: William Strunk Jr., *The Elements of Style* (1918), public domain. Frozen copy — not auto-synced with the upstream plugin. -->
